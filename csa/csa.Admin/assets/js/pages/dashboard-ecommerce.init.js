...
var options, chart, linechartcustomerColors = getChartColorsArray("customer_impression_charts"),
    ...
    worldemapmarkers = (chartDonutBasicColors && (options = {
        ...
        labels: ["Draft", "Pending Payment", "Order Confirmed", "Prepare to Ship", "Completed"],
        chart: {
            height: 333,
            type: "donut"
        },
...
function loadCharts() {
    ...
    e && (document.getElementById("sales-by-locations").innerHTML = "", worldemapmarkers = "", worldemapmarkers = new jsVectorMap({
        ...
        markers: [{
            name: "China",
            coords: [35.9583, 104.1361]
        }, {
            name: "Taiwan",
            coords: [23.5531, 121.0211]
        }, {
            name: "Malaysia",
            coords: [4.1406, 109.6168]
        }, {
            name: "Thailand",
        ...
        "insets": [{ "width": 900.0, "top": 0, "height": 440.7063107441331, "bbox": [{ "y": -12671671.123330014, "x": -20004297.151525836 }, { "y": 3930392.025135122, "x": 10026572.394749384 }], "left": 0 }], "paths": {
            ...
            "SG": { "path": "M103.97,1.331L103.82,1.265L103.65,1.326L103.705,1.423L103.818,1.447L103.909,1.416L103.961,1.392L103.996,1.365L103.97,1.331z", "name": "Singapore" },
        ...
        "height": 250, "projection": { "type": "mill", "centralMeridian": 0.0 },
        "width": 320
    }));
}
