<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewCampaign.aspx.cs" Inherits="csa.Admin.AddNewCampaign" %>
    ...
    <script type="text/javascript">
        ...
        btnSubmit.click(async function (e) {
            ...
            if (form.valid()) {
                ...
                const res = await ApiHelper.post(window.location.origin + '/Campaign/Create', payload)
                if (!res.data.Error) {
                    dialogHelper.successAutoRedirect('Campaign created', '<%= Page.ResolveUrl("~/EmailCampaign") %>')
                } else {
