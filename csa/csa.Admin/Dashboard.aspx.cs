...
namespace csa.Admin
{
    public partial class Dashboard : System.Web.UI.Page
    {
        ...
        {
            var vm = new DashboardAdminViewModel(MemberBiz.GetMemberNeedApprovalGVByAdmin(string.Empty, 0, 10, "m.CreateDate", SQLSelect.OrderByEnum.DESC).ObjVal, WithdrawalBiz.GetRequestGVByAdmin(string.Empty, 0,10, "w.CreateDate", SQLSelect.OrderByEnum.DESC).ObjVal,
                MemberBiz.GetTopReferrals(10));
