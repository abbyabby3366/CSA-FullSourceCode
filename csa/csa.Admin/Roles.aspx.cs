...
namespace csa.Admin
{
    public partial class Roles : System.Web.UI.Page
    {
        ...
        {
            hfModelView.Value = JsonConvert.SerializeObject(new AdminRolesViewModel(RoleBiz.GetListAccess(),RoleBiz.Gets().Select(x=> new Model.DataObject.ValueText<int>(x.RoleId,x.Name)).ToList()));
        }
