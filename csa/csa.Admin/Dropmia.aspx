<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dropmia.aspx.cs" Inherits="csa.Admin.Dropmia" %>
                ...
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-16 mb-1">Drop/MIA List</h4>
    ...
    <script type="text/javascript">
        ...
        function initMemberGV() {
            gvData = $("#gvData").DataTable({
                ...
                //'scrollCollapse': true,
                'ajax': {
                    'url': '<%=Page.ResolveUrl("~/Member/GetDropMiaGV")%>',
                    'type': "POST",
                    'data': function (e) {
                        let search = '';
