<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewAudienceTag.aspx.cs" Inherits="csa.Admin.AddNewAudienceTag" %>
    ...
    <script type="text/javascript">
        ...
        btnSubmit.click(async function (e) {
            ...
            if (form.valid()) {
                ...
                const res = await ApiHelper.post(window.location.origin + '/Tag/CreateTag', payload)
                if (!res.data.Error) {
                    dialogHelper.successAutoRedirect('Tag created', '<%= Page.ResolveUrl("~/AudienceTag") %>')
                } else {
