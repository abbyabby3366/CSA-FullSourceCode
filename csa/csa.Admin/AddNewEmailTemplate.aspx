<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewEmailTemplate.aspx.cs" Inherits="csa.Admin.AddNewEmailTemplate" %>
    ...
    <script>
        ...
        btnSave.click(async function (e) {
            ...
            if (form.valid()) {
                ...
                const res = await ApiHelper.post(window.location.origin + '/Tmplateemail/Create', payload)
                if (!res.data.Error) {
                    dialogHelper.successAutoRedirect('Email template created', '<%= Page.ResolveUrl("~/EmailTemplate") %>')
                } else {
