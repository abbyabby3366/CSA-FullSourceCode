<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminDetails.aspx.cs" Inherits="csa.Admin.AdminDetails" %>
                ...
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-16 mb-1">Admin Details</h4>
                                            ...
                                            <div class="form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                     ...
                                                     <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="ddlRole" class="form-label">Status</label>
    ...
    <script type="text/javascript">
        ...
        function tabUIControl() {
            $('button[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
                ...
                if (tabPrsnl.length == 0 || tabChgPwd.length == 0) { return; }
        ...
        function setEdit() {
            txtName.val(vm.Admin.Name)
            txtEmail.val(vm.Admin.Email)
            ddlRole.val(vm.Admin.RoleId)
            ddlStatus.val(vm.Admin.StatusId)
        }
        ...
        btnSavePassword.click(async function (e) {
            ...
            const payload = {
                ...
                adminToChangePasswordId: vm.Admin.AdminId,
                currentPassword: txtCurrentPass.val(),
                newPassword: txtNewPassword.val(),
                confirmNewPassword: txtConfirmNewPassword.val(),
            }
            const res = await ApiHelper.post(window.location.origin + '/admin/changePasswordByAdmin', payload)
            if (!res.data.Error) {
        ...
        btnSavePersonalDetails.click(async function (e) {
            ...
            const res = await ApiHelper.postFormData(window.location.origin + '/admin/update', payload)
            if (!res.data.Error) {
                dialogHelper.successAutoRedirect('Admin updated',"<%= Page.ResolveUrl("~/Admins")%>")
            } else {
                dialogHelper.error(res.data.Message)
            }
