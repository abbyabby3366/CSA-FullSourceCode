<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Referrals.aspx.cs" Inherits="csa.Member.Referrals" %>
                ...
                <div class="col-12">
                    <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-16 mb-1">Referral Details</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="col-md-3 col-sm-12 d-flex align-items-center"><h5 class="m-0 p-0 "><%--List Of Referral--%></h5></div>
                            ...
                            <table id="gvReferral" class="table dt-responsive nowrap align-middle" style="width: 100%">
...
<asp:Content ID="Script" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function initReferralGV() {
            gvTable = $("#gvReferral").DataTable({
                'responsive': false,
                //'buttons': [
                //    'print',
                //    'copyHtml5',
                ...
                //'scrollCollapse': true,
                'ajax': {
                    'url': '<%=Page.ResolveUrl("~/Member/GetReferralGVByMember")%>',
                    'type': "POST",
                    'data': function (e) {
                        let search = '';
                        ...
                        //    'Length': e.length,
                        //    'Order': JSON.stringify(e.order),
                        //    'Search': JSON.stringify(e.search)
                        //};
                    },
                ...
                'columns': [
                    ...
                    { 'data': 'MemberId', 'type': 'string' },
                    { 'data': 'CreateDate', 'type': 'date' },
                    { 'data': 'ReferralType', 'type': 'string' },
                    { 'data': 'Remark', 'type': 'string' },
                    { 'data': 'StatusId', 'type': 'int' },
                    { 'data': 'ReferralAmount', 'type': 'num' }
                ],
                'order': [
                    [3, "desc"]
                ],
                ...
                'columnDefs': [
                    ...
                    },
                    {
                        ...
                        'render': function (d, t, r, m) {
                            if (d != null) {
                                switch (d) {
                                    case 1: return `<span class='text-primary'>STAGE #1 - FINANCIAL SURVEY</span>`;
                                        break;
                                    case 2: return `<span class='text-warning'>STAGE #2 - ATTENDED A GROUP WEBSINAR</span>`;
                                        break;
                                    case 3: return `<span class='text-danger'>STAGE #3 - 1ON1ZOOMWITHPFC</span>`;
                                        break;
                                    case 4: return `<span class='text-success'>STAGE #4 - MISSION PARTNER</span>`;
                                        break;
                                    case 5: return `<span class='text-success'>STAGE #5 - RNR APP STARTED OR COMPLETED</span>`;
                                        break;
                                }
                            } else { return ''; }
                        }
