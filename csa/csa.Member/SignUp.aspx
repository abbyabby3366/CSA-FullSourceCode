<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExt.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="csa.Member.SignUp" %>
                                    ...
                                    <div class="form needs-validation" novalidate>
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <span>+60</span>
                                                <input type="text" class="form-control" id="txtPhoneNo" placeholder="Enter phone number" required>
                                            </div>
                                       ...
                                       <%-- <div class="mb-4">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-tertiary w-100" type="submit" id="btnSignUp">Sign Up</button>
                                        </div>
    ...
    <script type="text/javascript">
        !function () {
            ...
            var password = document.getElementById("password-input"),
                confirm_password = document.getElementById("confirm-password-input"), phoneNo = document.getElementById('txtPhoneNo');
            ...
            $('#btnSignUp').click(async function (e) {
                validatePassword()
                ...
                const res = await ApiHelper.post(window.location.origin + '/auth/register', payload)
                if (!res.data.Error) {
                    dialogHelper.successAutoRedirect('Signup successfully','<%= Page.ResolveUrl("~/SignIn")%>')
                } else {
